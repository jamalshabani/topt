...
# 4. I Beam         : python3 compliance.py -tao_monitor -l 6.0 -tao_max_it 1000 -v 0.4 -k 1.0e-2 -e 5.0e-3 -o 'IBeam' -m 'IBeam.msh'
# 4. beam With Hole : python3 compliance.py -tao_monitor -l 6.0 -tao_max_it 1000 -v 0.4 -k 1.0e-2 -e 5.0e-3 -o 'beamWithHole' -m 'beamWithHole.msh'
...
# Define double-well potential W function i.e W(x) = x^2(1 - x)^2
def W(rho):
