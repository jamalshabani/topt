...
program_list = ["rm -rf test1", "rm -rf test2", "rm -rf test3",
                "python3 tao_compliance.py -tao_bncg_type ssml_brdn -tao_converged_reason -tao_bncg_alpha 1.0 -tao_monitor -tao_max_it 3000 -tao_ls_type unit -tao_gatol 1e-7 -m '1_to_3_mesh.msh' -o 'test1' -er 1.0 -es 1.0e-2 -vr 0.3 -vs 0.5 -lr 5.0 -ls 0.17 -k 5.0e-3 -e 4.0e-3 -p 2.0 -q 1.0"]
