...
program_list = ["rm -rf test1", "rm -rf test2", "rm -rf test3",
                "python3 motion.py -tao_type bncg -tao_bncg_type gd -tao_max_funcs 10000 -tao_gatol 1.0e-7 -tao_grtol 1.0e-7 -tao_gttol 1.0e-7 -tao_converged_reason -tao_monitor -tao_max_it 5000 -tao_ls_type unit -m 'motion.msh' -o 'test1' -er 1.0 -es 1.0e-2 -lr 0.5 -ls 0.125 -vr 0.5 -vs 0.3 -k 5.0e-3 -e 4.0e-3 -p 2.0 -q 2.0"]
